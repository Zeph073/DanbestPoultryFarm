@extends('app-layout')
@section('title', 'Fresh Chicken Meat | DanBest Poultry Farm')
@section('description', 'Tender, healthy, farm-fresh chicken meat. Hygienically processed and perfect for families, hotels, and restaurants in Turkana and beyond.')
@section('keywords', 'fresh chicken meat, chicken for sale, organic chicken meat, DanBest Poultry Farm, Lodwar')
@section('main')
            ...
            <nav class="flex mb-6" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                            <span class="ml-1 text-sm font-medium text-[#f5d118] md:ml-2">Fresh Chicken Meat</span>
                        </div>
                    </li>
                </ol>
            </nav>
                ...
                <div class="lg:w-1/4">
                    <div class="bg-white rounded-lg shadow-md p-6 sticky top-4">
                        ...
                        <ul class="space-y-3">
                            ...
                            <li>
                                <a href="/fresh-chicken-meat" class="flex items-center p-2 bg-[#f5d118] bg-opacity-20 rounded-lg group">
                                    <div class="w-8 h-8 bg-[#f5d118] rounded-full flex items-center justify-center mr-3">
                                        <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                                    </div>
                                    <span class="font-medium text-[#1b3c4d] group-hover:text-black">Fresh chicken meat</span>
                                </a>
                            </li>
                ...
                <div class="lg:w-3/4">
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div class="bg-[#1b3c4d] text-white p-6">
                            <h1 class="text-2xl md:text-3xl font-bold mb-2">Fresh Chicken Meat</h1>
                            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                                <div class="flex items-center mb-2 md:mb-0">
                                    ...
                                    <span class="font-medium">Tender, hygienic, and delicious</span>
                                </div>
                                <div class="flex items-center">
                                    ...
                                    <span>Processed fresh on order</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex flex-col lg:flex-row gap-8">
                                ...
                                <div class="lg:w-1/2">
                                    ...
                                    <div class="mt-6 bg-[#f5d118] bg-opacity-10 rounded-lg p-4">
                                        <h3 class="font-bold text-[#1b3c4d] mb-2">Meat Fast Facts</h3>
                                        <ul class="list-disc pl-5 text-gray-700 text-sm">
                                            <li>Processed fresh on order</li>
                                            <li>Available whole or in portions</li>
                                            <li>Free from hormones and antibiotics</li>
                                            <li>Perfect for home, hotels, and events</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="lg:w-1/2">
                                    <div class="mb-6">
                                        <h2 class="text-xl font-bold text-[#1b3c4d] mb-2">Why DanBest Chicken Meat?</h2>
                                        <p class="text-gray-700 mb-4">
                                            Enjoy the taste of real, farm-fresh chicken! Our meat is tender, juicy, and processed hygienically for your safety. Perfect for family meals, restaurants, and special occasions.
                                        </p>
                                        <!-- Creative Infographic Block -->
                                        <div class="flex flex-col md:flex-row gap-3 mb-4">
                                            <div class="flex-1 bg-[#f5d118] bg-opacity-20 rounded p-3 text-center">
                                                <span class="block text-2xl font-bold text-[#1b3c4d]">100%</span>
                                            ...
                                            <div class="flex-1 bg-[#f5d118] bg-opacity-20 rounded p-3 text-center">
                                                ...
                                                <span class="block text-xs text-gray-700">Naturally raised</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="list-disc pl-5 space-y-1 text-gray-700">
                                        ...
                                        <li>Whole or cut portions available</li>
                                        <li>Ideal for home, hotels, and events</li>
                                        <li>Safe, hygienic, and delicious</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mt-8 bg-white rounded-lg shadow-md overflow-hidden">
                        <div class="border-b border-gray-200">
                            <nav class="flex -mb-px" id="tabs">
                                ...
                                <button class="w-1/3 py-4 px-1 text-center border-b-2 font-medium text-sm border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300" onclick="showTab('prep')">
                                    Cooking & Prep
                                </button>
                        ...
                        <div class="p-6">
                            <div id="tab-description">
                                <h3 class="text-lg font-bold text-[#1b3c4d] mb-4">About Our Chicken Meat</h3>
                                <p class="text-gray-700">
                                    Our chicken meat is processed fresh on order, ensuring maximum flavor and nutrition. We never use hormones or unnecessary antibiotics—just healthy, naturally raised birds.
                                </p>
                            </div>
                            <div id="tab-prep" style="display:none;">
                                <h3 class="text-lg font-bold text-[#1b3c4d] mb-4">Cooking & Prep Tips</h3>
                                <ul class="list-disc pl-5 space-y-1 text-gray-700">
                                    <li>Rinse meat under clean water before cooking</li>
                                    <li>Marinate for added flavor and tenderness</li>
                                    <li>Grill, fry, stew, or roast for best results</li>
                                    <li>Store in the fridge and use within 2 days</li>
                                </ul>
                                <div class="mt-4 bg-[#f5d118] bg-opacity-10 border-l-4 border-[#f5d118] p-3 rounded">
                                    ...
                                    <a href="#" class="underline text-[#1b3c4d]">Chicken Recipe Guide (PDF)</a>
                                </div>
                            </div>
                            <div id="tab-testimonials" style="display:none;">
                                ...
                                <blockquote class="border-l-4 border-[#f5d118] pl-4 italic text-gray-700 mb-2">
                                    "DanBest chicken is always fresh and tasty. My family loves it!" <br> <span class="text-sm">— Beatrice, Lodwar</span>
                                </blockquote>
                                <blockquote class="border-l-4 border-[#f5d118] pl-4 italic text-gray-700">
                                    "Perfect for our hotel menu—juicy, tender, and safe for our guests." <br> <span class="text-sm">— Chef Peter, Turkana</span>
                                </blockquote>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function showTab(tab) {
            ...
            document.getElementById('tab-prep').style.display = 'none';

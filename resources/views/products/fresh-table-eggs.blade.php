                            ...
                            <div class="flex flex-col lg:flex-row gap-8">
                                ...
                                <div class="lg:w-1/2">
                                    <div class="relative rounded-lg overflow-hidden mb-4 h-64 bg-gray-100 flex items-center justify-center">
                                        <img id="mainImage" src="https://images.unsplash.com/photo-1556905055-8f358a7a47b2?auto=format&fit=crop&w=600&q=80" alt="Fresh table eggs" class="w-full h-full object-cover">
                                    </div>
                                    <div class="grid grid-cols-4 gap-2">
                                        ...
                                        <div class="h-16 bg-gray-200 rounded-md overflow-hidden cursor-pointer border-2 border-transparent hover:border-[#f5d118]" onclick="changeImage('https://images.unsplash.com/photo-1567306314424-55c9 c0d81d7f?auto=format&fit=crop&w=600&q=80')">
                                ...
                                <div class="lg:w-1/2">
                                    <div class="mb-6">
                                        ...
                                        <div class="flex flex-col md:flex-row gap-3 mb-4">
                                            ...
                                            <div class="flex-1 bg-[#1b3c4d] bg-opacity-10 rounded p-3 text-center">
                                                <span class="block text-2xl font-bold text-[#1b3c4d]">Farm Fresh</span>
                                                <span class="block text-xs text-gray-700">Delivered daily</span>
                                            </div>
                                            <div class="flex-1 bg-[#f5d118] bg-opacity-20 rounded p-3 text-center">
                                    ...
                                    <div class="bg-[#1b3c4d] bg-opacity-10 border-l-4 border-[#f5d118] p-4 rounded mb-6">
                                        ...
                                        <p class="text-sm text-gray-700">
                                            Want the best eggs in Turkana? <a href="https://wa.me/254721577451" class="underline text-[#1b3c4d]">Chat with us on WhatsApp</a> or call <a href="tel:0721577451" class="underline text-[#1b3c4d]">0721 577 451</a> for free advice.
                                        </p>
                                    </div>
                                    <!-- Features List -->

@extends('app-layout')
@section('title', 'Fresh Table Eggs | DanBest Poultry Farm')
@section('description', 'High-quality fresh table eggs from healthy hens. Perfect for families, hotels, and restaurants in Turkana and beyond.')
@section('keywords', 'fresh table eggs, chicken eggs, organic eggs, DanBest Poultry Farm, Lodwar')
@section('main')
            ...
            <nav class="flex mb-6" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                            <span class="ml-1 text-sm font-medium text-[#f5d118] md:ml-2">Fresh Table Eggs</span>
                        </div>
                    </li>
                </ol>
            </nav>
                ...
                <div class="lg:w-1/4">
                    <div class="bg-white rounded-lg shadow-md p-6 sticky top-4">
                        ...
                        <ul class="space-y-3">
                            ...
                            <li>
                                <a href="/fresh-table-eggs" class="flex items-center p-2 bg-[#f5d118] bg-opacity-20 rounded-lg group">
                                    <div class="w-8 h-8 bg-[#f5d118] rounded-full flex items-center justify-center mr-3">
                                        <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                                    </div>
                                    <span class="font-medium text-[#1b3c4d] group-hover:text-black">Fresh table eggs</span>
                                </a>
                            </li>
                            <li>
                        ...
                        <div class="bg-[#1b3c4d] text-white p-6">
                            ...
                            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span>From Healthy Hens, Daily</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex flex-col lg:flex-row gap-8">
                                ...
                                <div class="lg:w-1/2">
                                    <div class="relative rounded-lg overflow-hidden mb-4 h-80 bg-gray-100 flex items-center justify-center">
                                        <img id="mainImage" src="https://sspoultryfarm.co.za/wp-content/uploads/2023/08/Fresh-table-eggs-768x768-1.png" alt="Fresh table eggs" class="w-full h-full object-cover">
                                    </div>
                                    <div class="grid grid-cols-4 gap-2">
                                        <div class="h-40 bg-gray-200 rounded-md overflow-hidden cursor-pointer border-2 border-transparent hover:border-[#f5d118]" onclick="changeImage('https://www.murraypropoultryfarm.com/wp-content/uploads/2022/02/Fresh-table-eggs4.jpg')">
                                            <img src="https://www.murraypropoultryfarm.com/wp-content/uploads/2022/02/Fresh-table-eggs4.jpg" alt="Eggs thumbnail 1" class="w-full h-full object-cover">
                                        </div>
                                        <div class="h-40 bg-gray-200 rounded-md overflow-hidden cursor-pointer border-2 border-transparent hover:border-[#f5d118]" onclick="changeImage('https://cpimg.tistatic.com/07202539/b/4/extra-07202539.jpeg')">
                                            <img src="https://cpimg.tistatic.com/07202539/b/4/extra-07202539.jpeg" alt="Eggs thumbnail 2" class="w-full h-full object-cover">
                                        </div>
                                        <div class="h-40 bg-gray-200 rounded-md overflow-hidden cursor-pointer border-2 border-transparent hover:border-[#f5d118]" onclick="changeImage('https://5.imimg.com/data5/OU/XG/MY-69757096/table-eggs-in-white-500x500.jpg')">
                                            <img src="https://5.imimg.com/data5/OU/XG/MY-69757096/table-eggs-in-white-500x500.jpg" alt="Eggs thumbnail 3" class="w-full h-full object-cover">
                                        </div>
                                        <div class="h-40 bg-gray-200 rounded-md overflow-hidden cursor-pointer border-2 border-transparent hover:border-[#f5d118]" onclick="changeImage('https://mcaicc.com/wp-content/uploads/2021/03/Image-2021-07-24-.jpg')">
                                            <img src="https://mcaicc.com/wp-content/uploads/2021/03/Image-2021-07-24-.jpg" alt="Eggs thumbnail 4" class="w-full h-full object-cover">
                                        </div>
                                    </div>
                                    <!-- Fast Facts -->
                                    <div class="mt-6 bg-[#f5d118] bg-opacity-10 rounded-lg p-4">
                                        <h3 class="font-bold text-[#1b3c4d] mb-2">Egg Fast Facts</h3>
                                        <ul class="list-disc pl-5 text-gray-700 text-sm">
                                            <li>Sourced from healthy, vaccinated hens</li>
                                            <li>High in protein and essential nutrients</li>
                                            <li>Perfect for cooking, baking, and eating raw</li>
                                            <li>Collected fresh daily</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="lg:w-1/2">
                                    <div class="mb-6">
                                        <h2 class="text-xl font-bold text-[#1b3c4d] mb-2">Why Choose DanBest Eggs?</h2>
                                        <p class="text-gray-700 mb-4">
                                            Our fresh table eggs come from healthy, well-cared-for hens, raised in a clean environment. Enjoy the rich flavor, high protein, and essential nutrients in every egg!
                                        </p>
                                        <!-- Creative Infographic Block -->
                                        <div class="flex flex-col md:flex-row gap-3 mb-4">
                                            <div class="flex-1 bg-[#f5d118] bg-opacity-20 rounded p-3 text-center">
                                                <span class="block text-2xl font-bold text-[#1b3c4d]">Protein Power</span>
                                                <span class="block text-xs text-gray-700">Essential amino acids</span>
                                            </div>
                                            <div class="flex-1 bg-[#1b3c4d] bg-opacity-10 rounded p-3 text-center">
                                                <span class="block text-2xl font-bold text-white">Farm Fresh</span>
                                                <span class="block text-xs text-white">Delivered daily</span>
                                            </div>
                                            <div class="flex-1 bg-[#f5d118] bg-opacity-20 rounded p-3 text-center">
                                                <span class="block text-2xl font-bold text-[#1b3c4d]">Happy Hens</span>
                                                <span class="block text-xs text-gray-700">Healthy, well-cared for</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bg-[#1b3c4d] bg-opacity-10 border-l-4 border-[#f5d118] p-4 rounded mb-6">
                                        ...
                                        <p class="text-sm text-white">
                                            Want the best eggs in Turkana? <a href="https://wa.me/254721577451" class="underline text-white">Chat with us on WhatsApp</a> or call <a href="tel:0721577451" class="underline text-white">0721 577 451</a> for free advice.
                                        </p>
                                    </div>
                                    <!-- Features List -->
                                    <ul class="list-disc pl-5 space-y-1 text-gray-700">
                                        <li>Sourced from our own healthy hens</li>
                                        <li>High protein, rich flavor</li>
                                        <li>Perfect for cooking, baking, or eating raw</li>
                                        <li>Available daily, fresh from the farm</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mt-8 bg-white rounded-lg shadow-md overflow-hidden">
                        <div class="border-b border-gray-200">
                            <nav class="flex -mb-px" id="tabs">
                                ...
                                <button class="w-1/3 py-4 px-1 text-center border-b-2 font-medium text-sm border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300" onclick="showTab('uses')">
                                    Egg Uses
                                </button>
                        ...
                        <div class="p-6">
                            <div id="tab-description">
                                <h3 class="text-lg font-bold text-[#1b3c4d] mb-4">About Our Fresh Table Eggs</h3>
                                <p class="text-gray-700">
                                    Our fresh table eggs are collected daily from healthy hens and delivered straight to you. We guarantee quality, nutrition, and delicious flavor in every egg.
                                </p>
                            </div>
                            <div id="tab-uses" style="display:none;">
                                <h3 class="text-lg font-bold text-[#1b3c4d] mb-4">Egg Uses</h3>
                                <ul class="list-disc pl-5 space-y-1 text-gray-700">
                                    <li>Cooking: omelets, frittatas, quiches</li>
                                    <li>Baking: cakes, cookies, bread</li>
                                    <li>Raw: smoothies, protein shakes</li>
                                    <li>Diet: source of protein</li>
                                </ul>
                                <div class="mt-4 bg-[#f5d118] bg-opacity-10 border-l-4 border-[#f5d118] p-3 rounded">
                                    ...
                                    <a href="#" class="underline text-[#1b3c4d]">Egg Recipe Guide (PDF)</a>
                                </div>
                            </div>
                            <div id="tab-testimonials" style="display:none;">
                                ...
                                <blockquote class="border-l-4 border-[#f5d118] pl-4 italic text-gray-700 mb-2">
                                    "DanBest eggs are the best in Lodwar. Always fresh and full of flavor!" <br> <span class="text-sm">— Sarah, Lodwar</span>
                                </blockquote>
                                <blockquote class="border-l-4 border-[#f5d118] pl-4 italic text-gray-700">
                                    "My family loves these eggs. Great for breakfast, baking, and everything in between!" <br> <span class="text-sm">— John, Turkana South</span>
                                </blockquote>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function showTab(tab) {
            ...
            document.getElementById('tab-uses').style.display = 'none';

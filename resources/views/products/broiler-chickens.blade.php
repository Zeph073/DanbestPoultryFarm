@extends('app-layout')
@section('title', 'Broiler Chickens | DanBest Poultry Farm')
@section('description', 'Fast-growing, healthy broiler chickens for meat production. Quality breeds, vaccinated and ready for your farm in Turkana and beyond.')
@section('keywords', 'broiler chickens, meat chicken, fast growing chicken, DanBest Poultry Farm, Lodwar')
@section('main')
            ...
            <nav class="flex mb-6" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                            <span class="ml-1 text-sm font-medium text-[#f5d118] md:ml-2">Broiler Chickens</span>
                        </div>
                    </li>
                </ol>
            </nav>
                ...
                <div class="lg:w-1/4">
                    <div class="bg-white rounded-lg shadow-md p-6 sticky top-4">
                        ...
                        <ul class="space-y-3">
                            ...
                            <li>
                                <a href="/broiler-chickens" class="flex items-center p-2 bg-[#f5d118] bg-opacity-20 rounded-lg group">
                                    <div class="w-8 h-8 bg-[#f5d118] rounded-full flex items-center justify-center mr-3">
                                        <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                                    </div>
                                    <span class="font-medium text-[#1b3c4d] group-hover:text-black">Broiler chickens</span>
                                </a>
                            </li>
                ...
                <div class="lg:w-3/4">
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div class="bg-[#1b3c4d] text-white p-6">
                            <h1 class="text-2xl md:text-3xl font-bold mb-2">Broiler Chickens</h1>
                            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                                <div class="flex items-center mb-2 md:mb-0">
                                    ...
                                    <span class="font-medium">Fast-growing, tender, and profitable</span>
                                </div>
                                <div class="flex items-center">
                                    ...
                                    <span>Ready for your table or market</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex flex-col lg:flex-row gap-8">
                                ...
                                <div class="lg:w-1/2">
                                    ...
                                    <div class="mt-6 bg-[#f5d118] bg-opacity-10 rounded-lg p-4">
                                        <h3 class="font-bold text-[#1b3c4d] mb-2">Broiler Fast Facts</h3>
                                        <ul class="list-disc pl-5 text-gray-700 text-sm">
                                            <li>Ready for sale/slaughter in 5-7 weeks</li>
                                            <li>Average live weight: 1.8-2.5kg</li>
                                ...
                                <div class="lg:w-1/2">
                                    <div class="mb-6">
                                        <h2 class="text-xl font-bold text-[#1b3c4d] mb-2">Why Choose DanBest Broilers?</h2>
                                        <p class="text-gray-700 mb-4">
                                            Our broiler chickens are bred for rapid growth, tender meat, and high feed efficiency. Perfect for commercial meat producers, hotels, restaurants, and families who want delicious, healthy chicken on the table fast!
                                        </p>
                                        <!-- Creative Infographic Block -->
                                        <div class="flex flex-col md:flex-row gap-3 mb-4">
                                            <div class="flex-1 bg-[#f5d118] bg-opacity-20 rounded p-3 text-center">
                                                <span class="block text-2xl font-bold text-[#1b3c4d]">5 Weeks</span>
                                            ...
                                            <div class="flex-1 bg-[#f5d118] bg-opacity-20 rounded p-3 text-center">
                                                ...
                                                <span class="block text-xs text-gray-700">High returns for farmers</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="list-disc pl-5 space-y-1 text-gray-700">
                                        <li>Fast-growing and efficient</li>
                                        <li>Consistent weight gain</li>
                                        <li>Ideal for commercial or home meat production</li>
                                        <li>Vaccinated and healthy stock</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mt-8 bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div class="p-6">
                            <div id="tab-description">
                                <h3 class="text-lg font-bold text-[#1b3c4d] mb-4">About Our Broilers</h3>
                                <p class="text-gray-700">
                                    DanBest broilers are selected for rapid growth, excellent meat quality, and disease resistance. They are ideal for farmers who want to maximize profits and efficiency in meat production.
                                </p>
                            </div>
                            <div id="tab-care" style="display:none;">
                                <h3 class="text-lg font-bold text-[#1b3c4d] mb-4">Broiler Care & Feeding Tips</h3>
                                <ul class="list-disc pl-5 space-y-1 text-gray-700">
                                    <li>Feed a high-protein broiler starter and finisher for best results</li>
                                    <li>Provide clean water at all times</li>
                                    <li>Maintain proper ventilation and temperature</li>
                                    <li>Monitor for rapid weight gain and health</li>
                                </ul>
                                <div class="mt-4 bg-[#f5d118] bg-opacity-10 border-l-4 border-[#f5d118] p-3 rounded">
                                    ...
                                    <a href="#" class="underline text-[#1b3c4d]">Broiler Success Guide (PDF)</a>
                                </div>
                            </div>
                            <div id="tab-testimonials" style="display:none;">
                                ...
                                <blockquote class="border-l-4 border-[#f5d118] pl-4 italic text-gray-700 mb-2">
                                    "DanBest broilers reach market weight fast and the meat is always tender. My customers are happy!" <br> <span class="text-sm">— Peter, Lodwar</span>
                                </blockquote>
                                <blockquote class="border-l-4 border-[#f5d118] pl-4 italic text-gray-700">
                                    "I love how easy they are to raise. High survival, fast growth, and great returns." <br> <span class="text-sm">— Alice, Turkana North</span>
                                </blockquote>
                            </div>
                        </div>
                    </div>

@extends('app-layout')
@section('title', 'Mature Laying Hens | DanBest Poultry Farm')
@section('description', 'High-quality mature laying hens, healthy and productive, ready to boost your egg production. Perfect for farmers and poultry enthusiasts in Turkana and beyond.')
@section('keywords', 'mature laying hens, egg production, kienyeji hens, poultry, DanBest Poultry Farm, Lodwar')
@section('main')
            ...
            <nav class="flex mb-6" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                            <span class="ml-1 text-sm font-medium text-[#f5d118] md:ml-2">Mature Laying Hens</span>
                        </div>
                    </li>
                </ol>
            </nav>
                ...
                <div class="lg:w-1/4">
                    <div class="bg-white rounded-lg shadow-md p-6 sticky top-4">
                        ...
                        <ul class="space-y-3">
                            ...
                            <li>
                                <a href="/mature-laying-hens" class="flex items-center p-2 bg-[#f5d118] bg-opacity-20 rounded-lg group">
                                    <div class="w-8 h-8 bg-[#f5d118] rounded-full flex items-center justify-center mr-3">
                                        <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                                    </div>
                                    <span class="font-medium text-[#1b3c4d] group-hover:text-black">Mature laying hens</span>
                                </a>
                            </li>
                            <li>
                ...
                <div class="lg:w-3/4">
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div class="bg-[#1b3c4d] text-white p-6">
                            <h1 class="text-2xl md:text-3xl font-bold mb-2">Mature Laying Hens</h1>
                            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                                <div class="flex items-center mb-2 md:mb-0">
                                    ...
                                    <span class="font-medium">Egg-laying champions, ready for your farm</span>
                                </div>
                                <div class="flex items-center">
                            ...
                            <div class="flex flex-col lg:flex-row gap-8">
                                ...
                                <div class="lg:w-1/2">
                                    ...
                                    <div class="mt-6 bg-[#f5d118] bg-opacity-10 rounded-lg p-4">
                                        <h3 class="font-bold text-[#1b3c4d] mb-2">Laying Hen Fast Facts</h3>
                                        <ul class="list-disc pl-5 text-gray-700 text-sm">
                                            <li>Age: 18+ weeks (ready to lay)</li>
                                            <li>Eggs per year: 250-300+</li>
                                            <li>Breeds: Kienyeji, Improved Kienyeji, Rainbow Rooster</li>
                                ...
                                <div class="lg:w-1/2">
                                    <div class="mb-6">
                                        <h2 class="text-xl font-bold text-[#1b3c4d] mb-2">Why Choose Our Laying Hens?</h2>
                                        <p class="text-gray-700 mb-4">
                                            Our mature laying hens are healthy, productive, and fully vaccinated—perfect for boosting your egg production instantly. Skip the wait and enjoy fresh eggs from day one!
                                        </p>
                                        <!-- Creative Infographic Block -->
                                        <div class="flex flex-col md:flex-row gap-3 mb-4">
                                            <div class="flex-1 bg-[#f5d118] bg-opacity-20 rounded p-3 text-center">
                                                <span class="block text-2xl font-bold text-[#1b3c4d]">250+</span>
                                            ...
                                            <div class="flex-1 bg-[#f5d118] bg-opacity-20 rounded p-3 text-center">
                                                ...
                                                <span class="block text-xs text-gray-700">Easy to manage</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="list-disc pl-5 space-y-1 text-gray-700">
                                        <li>18+ weeks old, ready to lay</li>
                                        <li>Vaccinated and healthy</li>
                                        <li>High-yield breeds for maximum egg production</li>
                                        <li>Perfect for home, school, or commercial farms</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mt-8 bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div class="p-6">
                            <div id="tab-description">
                                <h3 class="text-lg font-bold text-[#1b3c4d] mb-4">About Our Laying Hens</h3>
                                <p class="text-gray-700">
                                    Our mature laying hens are raised in clean, well-managed environments and are selected for productivity and resilience. They are perfect for farmers who want to start collecting eggs immediately, with minimal wait and risk.
                                </p>
                            </div>
                            <div id="tab-care" style="display:none;">
                                <h3 class="text-lg font-bold text-[#1b3c4d] mb-4">Layer Management Tips</h3>
                                <ul class="list-disc pl-5 space-y-1 text-gray-700">
                                    <li>Provide a balanced layer mash for best egg yield</li>
                                    <li>Ensure constant access to clean water</li>
                                    <li>Keep housing clean, dry, and well-ventilated</li>
                                    <li>Collect eggs daily to avoid breakage and spoilage</li>
                                ...
                                <div class="mt-4 bg-[#f5d118] bg-opacity-10 border-l-4 border-[#f5d118] p-3 rounded">
                                    ...
                                    <a href="#" class="underline text-[#1b3c4d]">Layer Management Guide (PDF)</a>
                                </div>
                            </div>
                            <div id="tab-testimonials" style="display:none;">
                                ...
                                <blockquote class="border-l-4 border-[#f5d118] pl-4 italic text-gray-700 mb-2">
                                    "I started collecting eggs the very next day! DanBest hens are healthy, friendly, and productive." <br> <span class="text-sm">— Mary, Lodwar</span>
                                </blockquote>
                                <blockquote class="border-l-4 border-[#f5d118] pl-4 italic text-gray-700">
                                    "Best layers in Turkana. My customers love the eggs and I love how easy they are to manage." <br> <span class="text-sm">— David, Kakuma</span>
                                </blockquote>
                            </div>
                        </div>
                    </div>

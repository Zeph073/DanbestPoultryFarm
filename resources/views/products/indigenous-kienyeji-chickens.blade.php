@extends('app-layout')
@section('title', 'Indigenous (Kienyeji) Chickens | DanBest Poultry Farm')
@section('description', 'Hardy, resilient indigenous (kienyeji) chickens for sustainable poultry farming. Perfect for free-range and organic egg/meat production.')
@section('keywords', 'kienyeji, indigenous chickens, local chicken, hardy chicken, DanBest Poultry Farm, Lodwar')
@section('main')
            ...
            <nav class="flex mb-6" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                            <span class="ml-1 text-sm font-medium text-[#f5d118] md:ml-2">Indigenous (Kienyeji) Chickens</span>
                        </div>
                    </li>
                </ol>
            </nav>
                ...
                <div class="lg:w-1/4">
                    <div class="bg-white rounded-lg shadow-md p-6 sticky top-4">
                        ...
                        <ul class="space-y-3">
                            ...
                            <li>
                                <a href="/indigenous-kienyeji-chickens" class="flex items-center p-2 bg-[#f5d118] bg-opacity-20 rounded-lg group">
                                    <div class="w-8 h-8 bg-[#f5d118] rounded-full flex items-center justify-center mr-3">
                                        <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                                    </div>
                                    <span class="font-medium text-[#1b3c4d] group-hover:text-black">Indigenous (kienyeji) chickens</span>
                                </a>
                            </li>
                            <li>
                ...
                <div class="lg:w-3/4">
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div class="bg-[#1b3c4d] text-white p-6">
                            <h1 class="text-2xl md:text-3xl font-bold mb-2">Indigenous (Kienyeji) Chickens</h1>
                            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                                <div class="flex items-center mb-2 md:mb-0">
                                    ...
                                    <span class="font-medium">Naturally resilient & locally adapted</span>
                                </div>
                                <div class="flex items-center">
                                    ...
                                    <span>Perfect for sustainable farming</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex flex-col lg:flex-row gap-8">
                                ...
                                <div class="lg:w-1/2">
                                    <div class="relative rounded-lg overflow-hidden mb-4 h-80 bg-gray-100 flex items-center justify-center">
                                        <img id="mainImage" src="https://jaguzafarm.com/support/wp-content/uploads/2019/11/kienyeji-chicken.jpg" alt="Indigenous kienyeji chicken" class="w-full h-full object-cover">
                                    </div>
                                    <div class="grid grid-cols-4 gap-2">
                                        <div class="h-40 bg-gray-200 rounded-md overflow-hidden cursor-pointer border-2 border-transparent hover:border-[#f5d118]" onclick="changeImage('https://www.kenyanews.go.ke/wp-content/uploads/2024/03/DSC_3352-1200x630.jpeg')">
                                            <img src="https://www.kenyanews.go.ke/wp-content/uploads/2024/03/DSC_3352-1200x630.jpeg" alt="Kienyeji thumbnail 1" class="w-full h-full object-cover">
                                        </div>
                                        <div class="h-40 bg-gray-200 rounded-md overflow-hidden cursor-pointer border-2 border-transparent hover:border-[#f5d118]" onclick="changeImage('https://i0.wp.com/ecochickspoultry.com/wp-content/uploads/2022/05/Indigenous-chicken-2.png?fit=700%2C465&ssl=1')">
                                            <img src="https://i0.wp.com/ecochickspoultry.com/wp-content/uploads/2022/05/Indigenous-chicken-2.png?fit=700%2C465&ssl=1" alt="Kienyeji thumbnail 2" class="w-full h-full object-cover">
                                        </div>
                                        <div class="h-40 bg-gray-200 rounded-md overflow-hidden cursor-pointer border-2 border-transparent hover:border-[#f5d118]" onclick="changeImage('https://i0.wp.com/farmhatch.co.ke/wp-content/uploads/2023/03/Chicken-Feeding-1024x640-Copy-2-1.jpg?resize=1024%2C640&ssl=1')">
                                            <img src="https://i0.wp.com/farmhatch.co.ke/wp-content/uploads/2023/03/Chicken-Feeding-1024x640-Copy-2-1.jpg?resize=1024%2C640&ssl=1" alt="Kienyeji thumbnail 3" class="w-full h-full object-cover">
                                        </div>
                                        <div class="h-40 bg-gray-200 rounded-md overflow-hidden cursor-pointer border-2 border-transparent hover:border-[#f5d118]" onclick="changeImage('https://kalrogaps.info/images/Local-Poultry.jpg')">
                                            <img src="https://kalrogaps.info/images/Local-Poultry.jpg" alt="Kienyeji thumbnail 4" class="w-full h-full object-cover">
                                        </div>
                                    </div>
                                    <!-- Fast Facts -->
                                    <div class="mt-6 bg-[#f5d118] bg-opacity-10 rounded-lg p-4">
                                        <h3 class="font-bold text-[#1b3c4d] mb-2">Kienyeji Fast Facts</h3>
                                        <ul class="list-disc pl-5 text-gray-700 text-sm">
                                            <li>Breed: Indigenous/local</li>
                                            <li>Eggs/year: 120-180 (on local feed)</li>
                                            <li>Meat: Rich, flavorful, and lean</li>
                                            <li>Perfect for free-range and organic systems</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="lg:w-1/2">
                                    <div class="mb-6">
                                        <h2 class="text-xl font-bold text-[#1b3c4d] mb-2">Why Kienyeji?</h2>
                                        <p class="text-gray-700 mb-4">
                                            Indigenous (kienyeji) chickens are Kenya’s heritage breed—naturally hardy, disease-resistant, and adapted to local conditions. They thrive on minimal inputs, making them perfect for sustainable and organic poultry farming.
                                        </p>
                                        <!-- Creative Infographic Block -->
                                        <div class="flex flex-col md:flex-row gap-3 mb-4">
                                            <div class="flex-1 bg-[#f5d118] bg-opacity-20 rounded p-3 text-center">
                                                <span class="block text-2xl font-bold text-[#1b3c4d]">Low Cost</span>
                                                <span class="block text-xs text-gray-700">Minimal feed, high resilience</span>
                                            </div>
                                            <div class="flex-1 bg-[#1b3c4d] bg-opacity-10 rounded p-3 text-center">
                                                <span class="block text-2xl font-bold text-white">Tasty Meat</span>
                                                <span class="block text-xs text-white">Preferred by families & hotels</span>
                                            </div>
                                            <div class="flex-1 bg-[#f5d118] bg-opacity-20 rounded p-3 text-center">
                                                <span class="block text-2xl font-bold text-[#1b3c4d]">Local Pride</span>
                                                <span class="block text-xs text-gray-700">Supports rural livelihoods</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bg-[#1b3c4d] bg-opacity-10 border-l-4 border-[#f5d118] p-4 rounded mb-6">
                                        <div class="flex items-center mb-2">
                                            ...
                                            <span class="font-bold text-white">Ask a Kienyeji Expert!</span>
                                        </div>
                                        <p class="text-sm text-white">
                                            Want to start a kienyeji project? <a href="https://wa.me/254721577451" class="underline text-white">Chat with us on WhatsApp</a> or call <a href="tel:0721577451" class="underline text-white">0721 577 451</a> for free advice.
                                        </p>
                                    </div>
                                    <!-- Features List -->
                                    <ul class="list-disc pl-5 space-y-1 text-gray-700">
                                        <li>Natural foragers—eat local grains, greens, insects</li>
                                        <li>Low input, high return</li>
                                        <li>Eggs and meat fetch premium prices</li>
                                        <li>Excellent for backyard, school, and community projects</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mt-8 bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div class="p-6">
                            <div id="tab-description">
                                <h3 class="text-lg font-bold text-[#1b3c4d] mb-4">About Our Kienyeji Chickens</h3>
                                <p class="text-gray-700">
                                    Our kienyeji chickens are bred for strength, resilience, and productivity. They are perfect for farmers who want to produce organic, free-range eggs and meat with minimal input and maximum flavor.
                                </p>
                            </div>
                            <div id="tab-tips" style="display:none;">
                                <h3 class="text-lg font-bold text-[#1b3c4d] mb-4">Kienyeji Tips</h3>
                                <ul class="list-disc pl-5 space-y-1 text-gray-700">
                                    <li>Allow chickens to free-range during the day for best health</li>
                                    <li>Supplement with local grains and kitchen scraps</li>
                                    <li>Provide shaded, predator-proof housing at night</li>
                                    <li>Collect eggs daily and keep nesting boxes clean</li>
                                </ul>
                                <div class="mt-4 bg-[#f5d118] bg-opacity-10 border-l-4 border-[#f5d118] p-3 rounded">
                                    ...
                                    <a href="#" class="underline text-[#1b3c4d]">Kienyeji Success Guide (PDF)</a>
                                </div>
                            </div>
                            <div id="tab-testimonials" style="display:none;">
                                ...
                                <blockquote class="border-l-4 border-[#f5d118] pl-4 italic text-gray-700 mb-2">
                                    "DanBest kienyeji are hardy and easy to keep. My family loves the taste and the eggs sell fast!" <br> <span class="text-sm">— Ruth, Lodwar</span>
                                </blockquote>
                                <blockquote class="border-l-4 border-[#f5d118] pl-4 italic text-gray-700">
                                    "Best birds for rural projects. They survive drought and still lay eggs. Highly recommend!" <br> <span class="text-sm">— John, Turkana East</span>
                                </blockquote>
                            </div>
                        </div>
                    </div>
